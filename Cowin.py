...
#For 21(Maharashtra) : https://cdn-api.co-vin.in/api/v2/admin/location/districts/21
#Note that you can just as well change the url by keeping the base url and then the State id
'''
{
  "districts": [
    {
  ...
  "sessions": [
    {
      ...
      "long": 72,
      "fee_type": "Free",
      "session_id": "a59c144e-e9b3-45e3-b692-e6f9f9773384",
      "date": "04-06-2021",
